...
const metrics = [
  { icon: GraduationCap, value: 12000, suffix: "+", label: "Students Learning ", note: "Across Our Schools & Colleges" },
  { icon: HandHeart, value: 700, suffix: "+", label: "Educators", note: "Dedicated teaching professionals across schools, colleges, and institutes" },
