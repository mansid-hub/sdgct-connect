...
import takshashilaShyam4 from "@/assets/takshashila-shyam-4.jpeg";
...
if (matoshriRamabai) {
  ...
  matoshriRamabai.imagePosition = "20% center";
  matoshriRamabai.imageScale = 0.95;  
...
if (prerna) {
  ...
  prerna.imagePosition = "center top";  
...
const takshashilaHospitalAbout: string[] = [
  ...
  "The hospital is equipped with modern diagnostic and treatment facilities, including X-ray, ECG, Pathology Laboratory, Physiotherapy Unit and Operation Theatres. The hospital has a 100-bed capacity, and provides outpatient (OPD) and inpatient (IPD) services, along with 24-hour emergency services.",
