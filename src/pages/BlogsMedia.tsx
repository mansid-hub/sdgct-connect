...
const stories = [
  ...
  },
  {
    ...
    gallery: [],
    tagline:
      "From the dusty fields of Balegaon to national fencing competitions — a journey powered by tenacity and sacrifice.",
    paragraphs: [
  ...
  },
  {
    ...
    gallery: [],
    tagline:
      "With the right aim, no target is too far \u2014 Gauri's rise from a small village to national archery championships.",
    paragraphs: [
